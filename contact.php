...
<div class="mdc-layout-grid amd-background-color--white" style="padding-top:48px;padding-bottom:48px">
  <div class="mdc-layout-grid__inner">
    ...
    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-2-desktop">
      <address>
        <p class="mdc-typography--body1"><strong>StoreCore</strong>™<br>Wildeman 62<br>5629&nbsp;KH&ensp;Eindhoven<br>The Netherlands</p>
      </address>
      <p><a class="amd-color--red-500" href="https://goo.gl/maps/XhN5jRS8dYAbqP2NA" style="text-decoration:none" title="Google Maps"><i class="material-icons" style="display:inline-block;margin-bottom:8px;padding-top:2px;vertical-align:-25%;">location_on</i> Google Maps</a></p>
    </div>
    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-2-desktop mdc-layout-grid__cell--align-middle">
      <div>
        <a href="/StoreCore.vcf" title="vCard">
          <amp-img alt="Scan this QR code for contact information." height="212" layout="fixed" src="/images/contact-qr-code.png" width="212">
        </a>
      </div>
